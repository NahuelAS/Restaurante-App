...
<body>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-dark bg-gray-900 sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="./Menus/entradas.php">Entradas</a>
                        <a class="collapse-item" href="./Menus/platoprincipal.php">Platos Principales</a>
                        <a class="collapse-item" href="./Menus/bebidas.php">Bebidas</a>
            ...
            <!-- <div class="sidebar-card d-none d-lg-flex">
                ...
                <a class="btn btn-success btn-sm" href="localhost/Apps/Menu/">Upgrade to Pro!</a>
            </div> -->
                    ...
                    <a href="db/cerrar_sesion.php"><i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i></a>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <!-- <a class="dropdown-item" data-toggle="modal" data-target="#logoutModal" href="db/cerrar_sesion.php">
    ...
    <script src="js/demo/chart-pie-rol.js"></script>
